...
def create_data_input_pin(
    ...
    return FlowPin(
        ...
        class_action=FlowAction.data,
        class_stream=FlowStream.input,
...
def create_data_output_pin(
    ...
    return FlowPin(
        ...
        class_docs=class_docs,
        class_action=FlowAction.data,
        class_stream=FlowStream.output,
        class_dtype=class_dtype,
        class_required=class_required,
        class_exported=class_exported,
        class_icon=class_icon,
