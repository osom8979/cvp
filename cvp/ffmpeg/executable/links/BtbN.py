...
_2_LINUX64_LICENSE = "gpl"

WIN64_URL = f"{_0}/{_1}/{_2_WIN64}{_2_WIN64_EXT}"
WIN64_SHA1 = _2_WIN64_SHA1
WIN64_LICENSE = _2_WIN64_LICENSE
...
LINUX64_SHA1 = _2_LINUX64_SHA1
LINUX64_LICENSE = _2_LINUX64_LICENSE
LINUX64_FFMPEG_SUB_PATH = f"{_2_LINUX64}/bin/ffmpeg.exe"
LINUX64_FFPROBE_SUB_PATH = f"{_2_LINUX64}/bin/ffprobe.exe"
